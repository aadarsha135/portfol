...
const App = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 font-inter px-4">
      <div className="text-center">
        <h1 className="text-5xl font-bold text-purple-700 mb-6">🚧 Site Under Maintenance</h1>
        <p className="text-lg text-gray-700">
          We're currently making updates. Please check back shortly.
        </p>
      </div>
    </div>
  );
...
// ...your full app code (Navbar, HomePage, ProjectsPage, etc.)...
